...
const contact_Details = require('../ContactDetails/contactDetails')
...
class User{
    ...
    static createAdmin(firstName , lastName){
        try {
            ...
            let tempAdmin = new User(++User.ID , firstName, lastName, true , true , []);
    ...
    createStaff(firstName , lastName){
        try {
            ...
            let tempStaff = new User(++User.ID, firstName, lastName, false, true, []);
